  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 -top-40 h-96 w-96 rounded-full bg-navy/6 blur-3xl dark:bg-cream/5" />
        <div className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-steel/10 blur-3xl dark:bg-navy/20" />
        ...
        <SignIn
          appearance={{
            elements: {
              ...
              identityPreviewEditButton: "text-navy dark:text-cream",
            },
          }}
        />
      </div>
